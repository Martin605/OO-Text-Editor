...
public class RecordEdits { //Originator
    ...
    public RecordMemento save() //將新的編輯動作存入RecordCaretaker的history Stack裡面，會在RecordCretaker使用
    {
        return new RecordMemento(getEdits(edits)); 
        //使用new和RecordMemento來創造新的edits(雙重陣列)，並回傳
    }

    public void restore(RecordMemento recordmemento) //將從history Stack pop出來的動作，設定到(覆蓋)目前的edits，來復原動作
    {
